...
| M1. Engineering foundation | `IN PROGRESS` | Engineering | Start `FND-05` database and migration foundation on the accepted contracts/domain kernel |
...
| `FND-05` Database and migration foundation | `READY` | Engineering | Write the package brief, then establish database schemas, migration conventions, tenant context, RLS harness, audit, idempotency, outbox, and change-event primitives |
| `FND-06` through `FND-09` | `NOT STARTED` | See roadmap | Pull in dependency order |
...
| ---: | --- | --- | --- | --- |
| 1 | `FND-05` Database and migration foundation | `READY` | `FND-04` contracts and domain kernel complete | Drizzle schema/migration conventions, tenant context, RLS harness, audit, idempotency, outbox, and change-event primitives compile |
...
The next status change should be `FND-05`: `READY` to `IN PROGRESS` when
