...
The worker keeps Node.js 26.4.0, QPDF 12.3.2, and the accepted HEIC codec pins.
The required `GHSA-f88m-g3jw-g9cj` remediation updates the exact renderer pair
from Sharp 0.34.5/libvips 8.17.3 to Sharp 0.35.3/libvips 8.18.3. F3 adds only the reviewed Debian Bookworm
