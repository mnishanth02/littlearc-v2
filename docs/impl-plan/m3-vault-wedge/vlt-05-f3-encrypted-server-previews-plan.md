...
- The current worker image uses Sharp 0.34.5 with a pinned custom libvips
  8.17.3 build. That minimal build enables HEIF but disables JPEG, PNG, Poppler,
...
Do not upgrade Sharp or libvips. Extend the reviewed worker image instead:

- retain Sharp 0.34.5 and libvips 8.17.3;
