...
the `VLT-04` plan and separately authorized its bounded implementation. These
directions do not close Gate 2, authorize `VLT-05` or later M3
breadth, or broaden any real-data, production, physical-iOS, two-device,
...
| `VLT-05` through `VLT-09` | `BLOCKED` | [Roadmap](../roadmap.md) | Gate 2 or separate founder direction is required |
