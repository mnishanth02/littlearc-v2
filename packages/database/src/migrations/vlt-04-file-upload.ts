export const vlt04FileUploadMigration = {
  description: "VLT-04 encrypted file objects and resumable upload sessions",
  filename: "0006_vlt_04_file_upload.sql",
  version: "0006_vlt_04_file_upload",
} as const;

export const vlt04FileUploadMigrationSql = `
begin;
...
values ('0006_vlt_04_file_upload', '__CHECKSUM_SHA256__')
