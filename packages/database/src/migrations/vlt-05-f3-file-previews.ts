export const vlt05F3FilePreviewsMigration = {
  description: "VLT-05-F3 encrypted validation previews and least-authority lifecycle",
  filename: "0008_vlt_05_f3_file_previews.sql",
  version: "0008_vlt_05_f3_file_previews",
} as const;

export const vlt05F3FilePreviewsMigrationSql = `
begin;
...
values ('0008_vlt_05_f3_file_previews', '__CHECKSUM_SHA256__')
