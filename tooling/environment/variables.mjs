export const environmentCatalog = {
  ...
  "apps/worker/.env.example": {
    ...
    APP_ENV: { classification: "public", owner: "FND-03", secret: false },
    DATABASE_URL: { classification: "secret", owner: "FND-05", secret: true },
    CLAMD_HOST: { classification: "sensitive", owner: "VLT-05", secret: true },
    CLAMD_PORT: { classification: "sensitive", owner: "VLT-05", secret: false },
    ...
    FILE_VALIDATION_ENABLED: { classification: "public", owner: "VLT-05", secret: false },
    FILE_VALIDATION_STAGING_PROBE: {
      classification: "public",
      owner: "VLT-05",
      secret: false,
    },
    FILE_VALIDATION_SANDBOX_EXECUTABLE: {
      classification: "sensitive",
      owner: "VLT-05",
      secret: false,
    },
    FILE_VALIDATION_TMP_DIR: {
      classification: "sensitive",
      owner: "VLT-05",
      secret: false,
    },
